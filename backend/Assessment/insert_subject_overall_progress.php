...
// 7. Delete existing for this student/advisory
// 8. Insert new
...
foreach ($insertRows as $row) {
    ...
    $checkStmt->execute([$row['student_id'], $row['advisory_id'], $row['subject_id']]);
...
echo json_encode(["status" => "success", "inserted" => $insertRows]); 