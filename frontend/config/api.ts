...
export const assessmentAPI = {
  ...
  // Subjects
  getSubjectsByAdvisory: (advisoryId: number) => 
    getEndpoint(`Assessment/get_subjects_by_advisory.php?advisory_id=${advisoryId}`),
  
  // Progress Cards
  getStudentProgressCards: (studentId: number, advisoryId: number) => 
  ...
  // Quarter Feedback
  getStudentQuarterFeedback: (studentId: number) => 
  ...
  // Overall Progress
  getOverallProgress: (studentId: number, advisoryId: number) => 
  ...
  getSubjectOverallProgress: (studentId: number, advisoryId: number) => 
  ...
  getMilestoneInterpretation: (studentId: number) => 
  ...
  getAdvisorySubjectAverages: (teacherId: number) => getEndpoint(`Assessment/get_advisory_subject_averages.php?teacher_id=${teacherId}`),
  getClassQuarterlyPerformance: (teacherId: number) => getEndpoint(`Assessment/get_class_quarterly_performance.php?teacher_id=${teacherId}`),
...
export const meetingAPI = {
  ...
  getNotificationRecipients: (meetingId: number) => 
