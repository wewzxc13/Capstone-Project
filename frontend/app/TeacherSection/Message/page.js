...
export default function TeacherMessagesPage() {
  ...
  function getQuickReplies(type, chat) {
    ...
    if (!chat) return [
      ...
      "When is the next faculty meeting?",
      "Can I help with lesson planning?",
    ...
    if (type === 'group') {
      ...
      if (gt === 'staff') {
        return [
          ...
          "Any classroom material requests?",
          "Need grading support?",
    ...
    switch (Number(chat.role)) {
      case 4: // Teacher to Parent
        return [
          "Your child is doing well.",
          "Here's this month's actvities.",
          "Let's discuss progress.",
          "Can we meet soon?",
          "Thanks for your support.",
        ];
      case 3: // Teacher to Teacher
        return [
          "How are students doing?",
          "What's your plan next week?",
          "Heard about the meeting?",
          "Want to share lesson plans?",
          "How's classroom management?",
        ];
      case 2: // Teacher to Admin
        return [
          "Need more class materials.",
          "When is the next meeting?",
          "I have policy concerns.",
          "Calendar updates please?",
          "Let's discuss curriculum.",
        ];
      case 1: // Teacher to Owner
        return [
