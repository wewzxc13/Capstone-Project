    ...
    switch (Number(chat.role)) {
      case 4: // Parent ↔ Teacher common
        return [
          ...
          "Please sign the consent form sent today.",
          "We noticed great improvement this week!",
          "Attendance update has been posted.",
        ];
      case 3: // Teacher ↔ Admin/Owner common
        return [
          "Please upload lesson plans by Friday.",
          "Do you need any classroom materials?",
      ...
      case 2: // Admin ↔ Owner/Super Admin common
        return [
          ...
          "Please coordinate with teachers for the event.",
          "Share the latest enrollment numbers.",
          "Update the newsletter draft by noon.",
