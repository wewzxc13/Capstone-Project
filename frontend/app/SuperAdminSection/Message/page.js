...
export default function SuperAdminMessagesPage() {
  ...
  function getQuickReplies(type, chat) {
    ...
    switch (Number(chat.role)) {
      case 4: // Parent ↔ Teacher common
        return [
          "Thank you for reaching out.",
          "Here's your child's progress update.",
          "Please sign consent form sent today.",
          "We noticed great improvement!",
          "Attendance update has been posted.",
        ];
      case 3: // Teacher ↔ Admin/Owner common
        return [
          "Please upload lesson plans by Friday.",
          "Do you need classroom materials?",
          "Reminder: faculty meeting at 3 PM.",
          "Kindly update grades by end of day.",
          "Thanks for your hard work!",
        ];
      case 2: // Admin ↔ Owner/Super Admin common
        return [
          "Let's review reports tomorrow.",
          "Please coordinate with teachers for event.",
          "Share the latest enrollment numbers.",
          "Update newsletter draft by noon.",
