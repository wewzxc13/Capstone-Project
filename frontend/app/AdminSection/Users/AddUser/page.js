...
import { FaUser, FaArrowLeft, FaCheckCircle, FaExclamationCircle, FaTimes, FaUsers, FaClipboardCheck, FaCalendarAlt, FaChevronDown, FaUserShield, FaChalkboardTeacher, FaChild } from "react-icons/fa";
...
export default function AddUserPage() {
  ...
  const validateForm = () => {
    ...
    if (isStudent) {
      ...
      // Government ID validation for Teacher only
      if (userType === "Teacher") {
