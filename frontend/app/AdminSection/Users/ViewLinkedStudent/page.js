              ...
              <>
                   ...
                   sortedParentsWithActiveStudents.length === 0 ? (
                     <div className="col-span-full bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-6 flex flex-col">
                      ...
                      return (
                       <div key={parent.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push(`/AdminSection/Users/ViewUser?id=${parent.id}&role=Parent`)}>
                        {/* Parent Header */}
