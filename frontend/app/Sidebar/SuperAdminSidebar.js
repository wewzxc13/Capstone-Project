...
const SuperAdminSidebar = ({ isSidebarOpen: desktopSidebarOpen, mobileOpenSignal, showInternalHamburger = true }) => {
  ...
  // Allow parent (e.g., Topbar) to open the mobile sidebar via a signal prop
  React.useEffect(() => {
